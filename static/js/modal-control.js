...
del_btn.forEach(del => {
    del.addEventListener("click", (e)=>{
        ...
        delValeur.setAttribute("href", "/index/"+child.textContent)
...
const formulaire = document.querySelector(".payment-list form")
...
edit_btn.forEach(edit => {
    edit.addEventListener("click", (e)=>{
        ...
        const matricule = allValues[5].childNodes[1].textContent
        const nom = allValues[7].childNodes[1].textContent
        const prenom = allValues[7].childNodes[3].textContent

        const date_naiss = allValues[9].childNodes[1].innerText
        const lieu_naiss = allValues[9].childNodes[3].innerText
        
        const adresse = allValues[11].childNodes[1].innerText
        const numTel = allValues[11].childNodes[3].innerText

        const allData = [matricule, nom, prenom, date_naiss, lieu_naiss, adresse, numTel]
